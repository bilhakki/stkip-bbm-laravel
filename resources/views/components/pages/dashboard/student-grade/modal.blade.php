...
>
    ...
    <form
        class="{{ $type }} relative p-6"
        method="post"
        action="{{ route('student-grade.store') }}"
        autocomplete="off"
    ...
    >
        ...
        <div class="grid grid-cols-1 gap-3">
            ...
            <div>
                ...
                <x-select
                    data-url="{{ route('course.index') }}"
                    name="course_id"
                    x-model="body.course_id"
                >
            ...
            <div>
                ...
                <x-select
                    data-url="{{ route('classroom.index') }}"
                    name="classroom_id"
                    x-model="body.classroom_id"
                >
