        ...
        <div class="space-y-2">
            <div class="grid gap-3 md:grid-cols-2">
                ...
                <x-select
                    ...
                    x-model="body.status"
                >
                    <option hidden>Pilih status kehadiran</option>
                    @foreach (StudentAttendanceStatus::values() as $item)
                        <option
                            class="uppercase"
                            value="{{ $item }}"
            ...
            <x-select
                class="!px-3 !py-2"
                data-url="{{ route('classroom-session.index') }}"
                name="classroom_session_id"
                x-model="body.classroom_session_id"
            >
